...
#load results from 7.2-Travis_data_analysis.R
...
beta[beta == 0] <- 1e-6  # Replace 0 with a small value
beta[beta == 1] <- 1 - 1e-6  # Replace 1 with a value slightly below 1
m = beta2m(beta)
...
pdf("/nfs/dcmb-lgarmire/xtyang/CordBlood/03-wenting_results/02-Travis_data/SOV_Travis_Gervin_m.pdf")
