...
#load results from 1 - Raw data pre-processing.Rmd 
load("/nfs/dcmb-lgarmire/xtyang/CordBlood/03-wenting_results/pd.RData")
...
pd = pd%>%dplyr::select("Sample_Group",  "Age", "BMI", "Eth2", "GA", "Parity","Smoker")
...
save(Ftab, Fmean, finalvars, file = "/nfs/dcmb-lgarmire/xtyang/CordBlood/03-wenting_results/01-new_result_Garvin_ref/sov_res_null_0213.RData")
...
pdf("/nfs/dcmb-lgarmire/xtyang/CordBlood/03-wenting_results/01-new_result_Garvin_ref/SOV_Gervin_nul_0213.pdf")
