...
load('/home/liuwent/04d-DM_analysis_after_adj/model1_residuals.RData')
load('/home/liuwent/04d-DM_analysis_after_adj/model2_residuals.RData')
load('/home/liuwent/04d-DM_analysis_after_adj/model3_residuals.RData')
...
# save(model1_residuals, file='model1_residuals.RData')
# load('/home/liuwent/04d-DM_analysis_after_adj/model1_residuals.RData')
...
# save(model2_residuals, file='model2_residuals.RData')
# load('/home/liuwent/04d-DM_analysis_after_adj/model2_residuals.RData')
...
# save(model3_residuals, file='model3_residuals.RData')
# load('/home/liuwent/04d-DM_analysis_after_adj/model3_residuals.RData')
...
# save(model1_PDS, file='model1_PDS.RData')
# load('/home/liuwent/04d-DM_analysis_after_adj/model1_PDS.RData')
...
model2_PDS <- quantify_pathways_deregulation(as.matrix(model2_residuals), 
                                             ...
                                             pd2, 
                                             attempts = 5, min_exp = 0, min_std = 0)
# save(model2_PDS, file='model2_PDS.RData')
# load('/home/liuwent/04d-DM_analysis_after_adj/model2_PDS.RData')
...
model3_PDS <- quantify_pathways_deregulation(as.matrix(model3_residuals), 
                                             ...
                                             pd2, 
                                             attempts = 5, min_exp = 0, min_std = 0)
# save(model3_PDS, file='model3_PDS.RData')
# load('/home/liuwent/04d-DM_analysis_after_adj/model3_PDS.RData')
...
# save(PDS_fit1, file = "PDS_fit1.RData")
# load('/home/liuwent/04d-DM_analysis_after_adj/PDS_fit1.RData')
...
# kegg_pathway = keggList('pathway','T01001')
# kegg_path_name = gsub('path:','',names(kegg_pathway))
# names(kegg_pathway) = kegg_path_name
# pathway_ttest_result1$anno = kegg_pathway[rownames(pathway_ttest_result1)]
...
# save(PDS_fit2, file = "PDS_fit2.RData")
# load('/home/liuwent/04d-DM_analysis_after_adj/PDS_fit2.RData')
...
# kegg_path_name = gsub('path:','',names(kegg_pathway))
# names(kegg_pathway) = kegg_path_name
# pathway_ttest_result2$anno = kegg_pathway[rownames(pathway_ttest_result2)]
...
# save(PDS_fit3, file = "PDS_fit3.RData")
# load('/home/liuwent/04d-DM_analysis_after_adj/PDS_fit3.RData')
...
# kegg_path_name = gsub('path:','',names(kegg_pathway))
# names(kegg_pathway) = kegg_path_name
# pathway_ttest_result3$anno = kegg_pathway[rownames(pathway_ttest_result3)]